...
export default function TopMenu() {
   ...
   return (
      <>
         <div className="flex items-center justify-between bg-sky-500 h-40 px-10">
            <CiMenuBurger
               onClick={handleMenu}
               className="cursor-pointer text-white w-8 h-8 hover:scale-110"
            />
            <h1 className="bg-sky-500 text-3xl">Sua Logo</h1>
            <div className="flex flex-col items-center gap-1 cursor-pointer hover:scale-110">
               <BsChatRightDots className="cursor-pointer text-white w-6 h-6 " />
               <p className="text-white">Suporte</p>
            </div>
         </div>

         {showMenu && (
            <div className="bg-sky-300 w-64 shadow-md z-10">
               <ul className="flex flex-col items-center items-stretch justify-center md:flex-nowrap">
                  <li
                     onClick={() => handleItemSelected("inicio")}
                     className={`flex py-2 px-4 justify-center cursor-pointer ${
                        selectedItem === "inicio" ? "bg-yellow-400" : "hover:bg-yellow-400"
                     }`}
                  >
                  ...
                  <li
                     ...
                     className={`flex py-2 px-4 justify-center cursor-pointer ${
                        selectedItem === "campanhas" ? "bg-yellow-400" : "hover:bg-yellow-400"
                     }`}
                  >
                     <div className="flex items-center gap-5">
                  ...
                  <li
                     ...
                     className={`flex py-2 px-4 justify-center cursor-pointer ${
                        selectedItem === "comunicados" ? "bg-yellow-400" : "hover:bg-yellow-400"
                     }`}
                  >
                     <div className="flex items-center gap-5">
                  ...
                  <li
                     ...
                     className={`flex py-2 px-4 justify-center cursor-pointer ${
                        selectedItem === "meus titulos" ? "bg-yellow-400" : "hover:bg-yellow-400"
                     }`}
                  >
                  ...
                  <li
                     ...
                     className={`flex py-2 px-4 justify-center cursor-pointer ${
                        selectedItem === "termos de uso" ? "bg-yellow-400" : "hover:bg-yellow-400"
                     }`}
                  >
                     <div className="flex items-center gap-5">
                  ...
                  <li
                     ...
                     className={`flex py-2 px-4 justify-center cursor-pointer ${
                        selectedItem === "cadastro" ? "bg-yellow-400" : "hover:bg-yellow-400"
                     }`}
                  >
                     <div className="flex items-center gap-5">
                  ...
                  <li
                     ...
                     className={`flex py-2 px-4 justify-center cursor-pointer ${
                        selectedItem === "ganhadores" ? "bg-yellow-400" : "hover:bg-yellow-400"
                     }`}
                  >
                     <div className="flex items-center gap-5">
                  ...
                  <li
                     ...
                     className={`flex py-2 px-4 justify-center cursor-pointer ${
                        selectedItem === "entrar" ? "bg-yellow-400" : "hover:bg-yellow-400"
                     }`}
                  >
                     <div className="flex items-center gap-5">
                  ...
                  <li
                     ...
                     className={`flex py-2 px-4 justify-center cursor-pointer ${
                        selectedItem === "adm" ? "bg-yellow-400" : "hover:bg-yellow-400"
                     }`}
                  >
